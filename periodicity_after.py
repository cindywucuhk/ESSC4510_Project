...
# plot attributes
plt.plot(df['datetime'],d,'k-'); plt.xlabel('time'); plt.ylabel('earthquake rate (no. of events/hr)'); plt.title('Number of earthquakes per hour');
#plt.show();
fig1.savefig("after.png")
...
fig2.savefig("after_amplitude.png")
#fig3.savefig("after_power.png")

## export s2 as after_power.txt
np.savetxt("after_power.txt", s2)
