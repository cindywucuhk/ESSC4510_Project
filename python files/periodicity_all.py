...
df = pd.read_csv("overall_earthquake_rate.csv")
print(df)
...
ax1 = plt.subplot(1,1,1);
plt.axis([df['datetime'][0], df['datetime'][Nraw-2], 0, 1.1*np.max(d) ]);
# plot attributes
...
#fig2.savefig("all_amplitude.png")
fig3.savefig("all_power.png")